...
- Full manual: [`docs/manual.typ`](docs/manual.typ) (中文) / [`docs/manual-en.typ`](docs/manual-en.typ) (English) — compile with `typst compile --root . docs/manual.typ` (or `docs/manual-en.typ`)
